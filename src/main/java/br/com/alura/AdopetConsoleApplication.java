...
public class AdopetConsoleApplication {
    ...
    private static void cadastrarAbrigo() throws IOException, InterruptedException {
        ...
        String uri = "http://localhost:8080/abrigos";
        HttpResponse<String> response = dispararRequisicaoPost(uri, json.toString());
    ...
    private static HttpResponse<String> dispararRequisicaoPost(String uri, String json) throws IOException, InterruptedException {
        HttpClient httpClient = HttpClient.newHttpClient();
        HttpRequest httpRequest = HttpRequest.newBuilder()
                .uri(URI.create(uri))
